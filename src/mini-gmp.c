...
mp_bitcnt_t mpn_scan0(mp_srcptr ptr, mp_bitcnt_t bit) {
    ...
    return mpn_common_scan(~ptr[i] & (GMP_LIMB_MAX << (bit % GMP_LIMB_BITS)), i, ptr, i,
                           GMP_LIMB_MAX);
}
...
static mp_limb_t mpn_div_qr_1_preinv(mp_ptr qp,
                                     mp_srcptr np,
                                     mp_size_t nn,
...
static void mpn_div_qr_preinv(mp_ptr qp,
                              mp_ptr np,
                              mp_size_t nn,
                              mp_srcptr dp,
                              mp_size_t dn,
...
static void mpz_div_r_2exp(mpz_t r,
                           const mpz_t u,
                           mp_bitcnt_t bit_index,
                           enum mpz_div_round_mode mode) {
    mp_size_t us, un, rn;
...
static unsigned long mpz_div_qr_ui(mpz_t q,
                                   mpz_t r,
                                   const mpz_t n,
                                   unsigned long d,
                                   enum mpz_div_round_mode mode) {
